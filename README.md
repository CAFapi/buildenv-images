...
This project builds a number of openSUSE-based images that include various versions of JDK, C++, Dotnet, OpenTofu and Python 3 along with Maven. They are intended to be used to build other images.
