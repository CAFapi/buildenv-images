...
This project builds a number of openSUSE-based images that include various versions of JDK, C++ and Dotnet along with Maven. They are intended to be used to build other images.
